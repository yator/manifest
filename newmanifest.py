...
#print(_mdate)
_mtype = 'C:/Users/AYator/Desktop/rev.doc@kenya-airways.com_data/*.txt'
for filename in glob.glob(_mtype):
    ...
    cursor.prepare(
        'insert into FLIGHTOPS.MANIFEST(FLIGHTNUMBER,FLIGHTDATE,FIGHTFROM,BISPAX,ECONPAX,  deptime,  boardtime,ITEM,'
        'PAXNAME,PAXTYPE,FRM,TOO,RBD,CLASSTRAVEL,SEAT,FIELD1,FIELD2,TICKETNUMBER,filename,procdate) values(:1,:2,:3,'
